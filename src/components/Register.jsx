    ...
    try {
      let response = await fetch(
       "https://potd-lol.herokuapp.com/potd/users/register",
        {
          method: "POST",
          body: JSON.stringify({ email: email, password: password, name: name, username: username, gender: gender}),
          headers: {
          ...
          ><img src={logo} alt="potd" width="200" className="mx-auto" />
            <Form onSubmit={signUpFetch} className="m-7">
                ...
                <input type="file" id="image"
                  ...
                  />
                <label htmlFor="image">
                {img ? <img src={URL.createObjectURL(img)} alt="monke"  className="w-full my-3 monkeImg container mx-auto" /> : <img src={monke} alt="monke"  className="w-full my-3 monkeImg container mx-auto" />}
                </label>
                </button>
